...
def help_text() -> str:
    ...
    return (
        ...
        "docs/reference/com_api_inventory.md §5). Классы «Из памяти» и\n"
        "«Порт выхода» (единственные в UNSUPPORTED_COM_BLOCK_CLASSES) add_block\n"
        "отвергает: это защита библиотеки, а не свойство COM. Замерено на живом\n"
        "COM 2026-09-18: CreateBlock создаёт обе записи и возвращает ненулевой\n"
        "id, блок появляется на странице и его свойства читаются; годность этих\n"
        "блоков в модели не проверена, поэтому защита оставлена.\n"
        "\n"
